/*
  ...
  * The PPL also needs satellite ephemeris data
  ...
  Hardware:
  This example is a copy of Example1, re-written for the SparkFun RTK EVK (Evaluation Kit) (Coming soon!)
  Select ESP32 Arduino \ ESP32 Wrover Module as the board
...
// SparkFun EVK v10 pin definitions
